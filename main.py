...
class WelcomePlugin(Star):
    ...
    @welcome.command("set", help="设置当前群欢迎语", alias={"设置欢迎"})
    ...
    @welcome.command("on", help="开启当前群欢迎功能", alias={"开启欢迎"})
    ...
    @welcome.command("off", help="关闭当前群欢迎功能", alias={"关闭欢迎"})
    ...
    @welcome.command("test", help="测试当前群欢迎语", alias={"测试欢迎"})
    ...
    @leave.command("set", help="设置退群消息", alias={"设置退群"})
    ...
    @leave.command("on", help="开启退群通知", alias={"开启退群"})
    ...
    @leave.command("off", help="关闭退群通知", alias={"关闭退群"})
    ...
    @kick.command("set", help="设置被踢消息", alias={"设置被踢"})
    ...
    @kick.command("on", help="开启被踢通知", alias={"开启被踢"})
    ...
    @kick.command("off", help="关闭被踢通知", alias={"关闭被踢"})
